...
//        ];
        ...
        $state = [
             ...
             -1365258909 => '63cd9fae',
               759513533 => 'bd41452d',
              -424228083 => '0dcbb6e6',
            -13765010209 => 'df9c8acb',
             -2824905881 => '675b9f57',
             -9887154026 => '9600aeb2',
             19352563566 => '6eaf8081',
              5669379852 => '0cdfeb51',
            -31581549269 => '2bcd97a5',
             21359466527 => '1f981ff9',
             10648459874 => '629ab27a',
             -8561790247 => 'd972ad01',
              9779462261 => '75c0e646',
            -22434204802 => '7e33d1c6',
             -4124492433 => '6f3d290a',
             19608647852 => 'ac38c490',
              9541915967 => '3f15be38',
              5144979599 => '8f28aa32',
             -4355863926 => '8aca5efc',
        ];
    ...
    protected static function transform($state)
    {
        ...
        for ($r = 0;$r < 8; $r += 1) {
            ...
            for ($i = 0; $i < 16; $i += 1) {
                ...
                $state[$i]       = 0xffffffff00000000 | (self::rotate($y[$i],  7)^$state[$i + 16]);
            }
            for ($i = 0; $i < 16; $i += 1) $y[$i^2]         = $state[$i + 16];
            for ($i = 0; $i < 16; $i += 1) $state[$i + 16]  = $y[$i] + $state[$i];
            for ($i = 0; $i < 16; $i += 1) $y[$i^4]         = $state[$i];
            for ($i = 0; $i < 16; $i += 1) $state[$i]       = 0xffffffff00000000 | (self::rotate($y[$i], 11)^$state[$i + 16]);
