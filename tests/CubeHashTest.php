...
class CubeHashTest extends TestCase
{
    ...
    public function test_cubehash512()
    {
        ...
        $this->assertEquals(
            [
                -2076518559,  -427597776,  -346873268, -1065459141,
                 1186444993,  1935766587,   387174437,   692467291,
                 2082094219,  2025172345, -1318508969,  -856074011,
                 -311914263, -2080261557,   988201904,   350797806,
                  289446903,  5213002413, -5832486309,  1158448569,
                 6068998475, -1141498701,  3502978787,  2079505445,
                 1183074299,  2172436991,  1964639834, 10066282182,
                 2139287255,  3757886630,  -332587439,  3590344934,
            ],
            CubeHash::iv(1, 1, 512)
        );
        $this->assertEquals(
        ...
        $this->assertEquals(
            '13cf99c1a71e40b135f5535bee02e151eb4897e4de410b9cb6d7179c677074eb6ef1ae9a9e685ef2d2807509541f484d39559525179d53838eda95eb3f6a401d',
            cubehash512(1, 1, 'Hello')
        );
        $this->assertEquals(
            ...
            cubehash512(1, 1, 'The quick brown fox jumps over the lazy dog')
        );
